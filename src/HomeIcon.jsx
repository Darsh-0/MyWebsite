    ...
    return (
        <div className="relative">
            <button onClick={() => navigate("/")} className="cursor-pointer" key="Home" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                <div className="bg-[#1F1F1F] rounded-full w-15 h-15 flex items-center justify-center transition-transform hover:scale-105 cursor-pointer hover:bg-[#2A2A2A] active:scale-95 active:duration-70">
